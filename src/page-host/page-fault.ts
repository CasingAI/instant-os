import type { ChromoErrorPayload, ChromoLoadFailedPayload } from './page-bridge.ts'

export type ChromoPageFaultSeverity = 'fatal' | 'load'
export type PageFaultSeverity = ChromoPageFaultSeverity
...
export type PageFault = ChromoPageFault
