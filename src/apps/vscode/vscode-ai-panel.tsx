...
import { SubagentIcon, VscodeIcon, PlusIcon } from '../../icons/app-icons.tsx'
...
export type VscodeAiComposerBlockProps = {
  value: string
  ...
  /** 为 true 时不渲染模式选择（ProDude 等固定 Agent） */
  hideMode?: boolean
...
export function VscodeAiComposerBlock({
  value,
  onChange,
  onSend,
  inputRef,
