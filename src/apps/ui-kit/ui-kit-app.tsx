...
import {
  ...
  ListIndexDemo,
  ListEditingDemo,
  ListPlainVariantDemo,
  ListPlainEditingDemo,
  DocumentTabBarDemo,
  AdaptiveActionMenuDemo,
  AdaptiveSplitNavDemo,
  WindowModalDemo,
  MiniWindowDemo,
...
const DEMO_COMPONENTS: Record<string, () => preact.JSX.Element> = {
  ...
  'list-selection': ListSelectionDemo,
  'list-controls': ListControlsDemo,
  'list-index': ListIndexDemo,
  'list-editing': ListEditingDemo,
  'list-plain-variant': ListPlainVariantDemo,
  'list-plain-editing': ListPlainEditingDemo,
  'document-tab-bar': DocumentTabBarDemo,
  'adaptive-action-menu': AdaptiveActionMenuDemo,
  'adaptive-split-nav': AdaptiveSplitNavDemo,
  'window-modal': WindowModalDemo,
  'mini-window': MiniWindowDemo,
